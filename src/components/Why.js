  ...
  return (
    <section className='why'>
        ...
        <div className='pros_top'>
                    <h2>These are why you should use Aparivest</h2>
                    <p>Discover the reasons why Aparivest is your top choice, offering unparalleled features, reliability, and support for your investment journey.</p>
                    <img src={divider} />
            </div>
